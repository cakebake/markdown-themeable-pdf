...
import { access, stat, readdirSync, readFile as _readFile, writeFile as _writeFile } from 'fs'
...
export const writeFile = (data, directory, fileName, fileExtension, charset) => {
