...
export const pdf = (htmlDocument, options) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const absolute = get(options, 'width') && get(options, 'height')
      const buffer = await page.pdf({
        ...
        format: !absolute ? get(options, 'format') : undefined,
        width: absolute ? get(options, 'width') : undefined,
        height: absolute ? get(options, 'height') : undefined,
