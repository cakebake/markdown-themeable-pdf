...
const CHROMIUM_REVISION_FALLBACK = '588429'
...
const getWantedRevisionNumber = () => {
  ...
  try {
    ...
    if (revision) {
      ...
      console.error(`Could not get chromium revision from ${path}`)
      return CHROMIUM_REVISION_FALLBACK
    }
  } catch (e) {
    console.error(`Could not get chromium revision from puppeteer package.json`)
    console.error(e)
    return CHROMIUM_REVISION_FALLBACK
  }
}
