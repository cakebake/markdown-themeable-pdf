...
import { readFile, readFilesCombine, writeFile, getFileDirectory, getFileName } from './filesystem'
  ...
  return new Promise(async (resolve, reject) => {
    if (!isEmpty(filePath)) {
      ...
      try {
        ...
        const css = await readFilesCombine(getCssFilePaths(get(opt, 'customStylesPath'), getProjectRootPathByFilePath(filePath)), CHARSET)
