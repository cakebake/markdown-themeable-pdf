...
module.exports = {
    ...
    activate: function () {
        ...
        var customTemplatesPath = path.join(atom.config.configDirPath, 'markdown-themeable-pdf');
        fs.copySync(__dirname + '/../templates', customTemplatesPath, function (err) {
            if (!err) {
                atom.notifications.addInfo('Custom templates were copied to ' + customTemplatesPath);
            }
        });
