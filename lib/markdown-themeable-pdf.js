...
module.exports = markdownThemeablePdf = {
    ...
    convertFile: function (filePath, encoding) {
        ...
        fs.readFile(filePath, encoding, function (err, markdown) {
            ...
            cssFile = markdownThemeablePdf.getConfigFilePath(atom.config.get('markdown-themeable-pdf.customStylesPath'));
            try {
                cssStyles += fs.readFileSync(cssFile, encoding) + '\n';
            } catch (err) {
                atom.notifications.addWarning('Stylesheet ' + cssFile + ' not found');
            ...
            var customHeader = (function () {
                ...
                var setting = markdownThemeablePdf.getConfigFilePath(atom.config.get('markdown-themeable-pdf.customHeaderPath'));
                try {
            ...
            var customFooter = (function () {
                ...
                var setting = markdownThemeablePdf.getConfigFilePath(atom.config.get('markdown-themeable-pdf.customFooterPath'));
                try {
                    var obj = require(setting)();
     ...
     */
    getConfigFilePath: function (relativePath) {
