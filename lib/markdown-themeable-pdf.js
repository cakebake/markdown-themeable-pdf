...
module.exports = markdownThemeablePdf = {
    config: {
        ...
        openPdfInAtomWorkspace: {
            type: 'boolean',
            default: true,
            description: 'Open PDF inside Atom (for example with <a href="https://atom.io/packages/pdf-view">pdf-view</a>)',
            order: 200
        }
    },
    subscriptions: null,
    ...
    convertFile: function (filePath, encoding) {
        ...
        fs.readFile(filePath, encoding, function (err, markdown) {
            ...
            var customHeader = (function () {
                ...
                var setting = path.normalize(atom.config.get('markdown-themeable-pdf.customHeaderPath'));
                try {
            ...
            var customFooter = (function () {
                ...
                var setting = path.normalize(atom.config.get('markdown-themeable-pdf.customFooterPath'));
                try {
                    var obj = require(setting)();
