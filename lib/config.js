...
import { getHighlightJsStyles, formatHighlightJsName } from './style/highlightJs'
...
const configHighlighting = () => {
  ...
  getHighlightJsStyles().forEach((value) => {
    themes.push({ value, description: formatHighlightJsName(value) })
  })
  return {
...
const configGeneral = () => {
  return {
    timeout: {
      ...
      type: 'integer',
      default: 30000,
      description: 'The maximum waiting time for document creation in milliseconds',
      order: 5
    },
    openFile: {
