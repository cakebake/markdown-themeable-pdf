...
export const options = (loadDefaults = false) => {
  return {
    ...
    pdf: {
      ...
      headerTemplate: '<span style="float: left;">Header: <span class="date"></span></span> <span style="float: right;">Page <span class="pageNumber"></span>/<span class="totalPages"></span></span>',
      footerTemplate: '<span style="float: left;">Footer: <span class="date"></span></span> <span style="float: right;">Page <span class="pageNumber"></span>/<span class="totalPages"></span></span>',
      margin: {
